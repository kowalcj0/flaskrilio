...
def step_impl(context):
    assert context.redir_resp["redirectTo"] != None
    ...
    "Received numberToCall: %s is the same as requested redirect_to_no: %s" \
    ...
    "Received redirectTo: '%s' is the same as received numberToCall: '%s'" \
    % (context.redir_resp["redirectTo"], context.redir_resp["numberToCall"])
...
def step_impl(context):
    ...
    """TO-DO
        ...
        like using wget
        wget --user=AC1748a660591e427ac079282e74d50ff0 --password=03588872f611332b772058c3f60cb607 https://api.twilio.com/2010-04-01/Accounts/AC1748a660591e427ac079282e74d50ff0/Recordings/RE2aee6402d1cfd392b45f30ed3ac202bc.mp3
    """
