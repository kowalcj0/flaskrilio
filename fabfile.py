...
def start_flaskrilio():
    ...
    sudo('sh -c \'cd /tmp/flaskrilio/%s/flaskrilio\' && MODE=EC2 nohup /tmp/flaskrilio/%s/flaskrilio/flaskriliosrv.py &> /tmp/flaskrilio/%s/flaskrilio/reports/nohup.txt &' % (DIST, DIST, DIST), pty=False)
